...
class CrazzyMobileCardBox extends StatelessWidget {
  final void Function()? onTap;
  final String textProduct;
  final String productImage;
  final String productPrice;
  const CrazzyMobileCardBox({super.key, required this.onTap, required this.textProduct, required this.productImage, required this.productPrice});
